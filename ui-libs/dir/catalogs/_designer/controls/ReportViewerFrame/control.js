(function(ActionAppCore, $) {
  ...
  ControlCode.getReportURL = function(theOptions) {
    ...
    if( this.reportData ){
      tmpRet.data = this.reportData;
    }
    return tmpRet;
  }
  ControlCode.setReportURL = function(theURL, theOptionalPostData) {
    this.reportURL = theURL;
    this.reportData = theOptionalPostData || false;
  }
  ControlCode.showReport = function(theOptions) {
    var dfd = jQuery.Deferred();
    var tmpOptions = theOptions || {};
    var tmpThis = this;
    var tmpURLObj = this.getReportURL(theOptions);
    var tmpURL = tmpURLObj.url;
    var tmpData = tmpURLObj.data || undefined;
